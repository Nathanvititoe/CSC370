...
import pandas as pd
from src.ui.introduction import introduction
...
# TODO: 
# turn visualizations back on
# fix confusion matrix
# make waveform plots smaller
# remove waveform padding on sides
# test custom user file (choice 1)
# shrink size of all plots
...
# Commented out for notebook segmentation
# main function
# def main():
    # %%
    ...
    print(f"\n\n\n{header_title_indent}Validate Model Training")
    print(f"{header_line_indent}-------------------------------\n")
